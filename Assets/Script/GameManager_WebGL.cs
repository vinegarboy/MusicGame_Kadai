...
public class GameManager_WebGL : MonoBehaviour{
    [SerializeField]
    ...
    async void Start(){
        ...
        notes = new List<Note>();
        MusicAnalyze_WebGL musicAnalyze = new MusicAnalyze_WebGL(audioClip,2048,512);
        ...
        foreach(Note note in notes){
            ...
            note_Object.GetComponent<NoteScript_WebGL>().manager = this;
        }
